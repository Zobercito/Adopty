import { B as PrerenderClientAddressNotAvailable, D as MiddlewareNotAResponse, E as MiddlewareNoDataOrNextCalled, K as StaticClientAddressNotAvailable, P as NoManifestAvailable, Q as isAstroError, T as LocalsReassigned, U as ReservedSlotName, W as ResponseSentError, X as i18nNoLocaleFoundInPath, Z as AstroError, a as ClientAddressNotAvailable, i as CacheNotEnabled, n as ActionsReturnedInvalidDataError, p as ForbiddenRewrite, r as AstroResponseHeadersReassigned, t as ActionNotFoundError, w as LocalsNotAnObject } from "./chunks/errors-data_PIFh9K3R.mjs";
import { a as matchPattern } from "./chunks/remoteProbe_C2yasnYm.mjs";
import { $ as pathHasLocale, B as renderEndpoint, C as renderJSX, Ct as stripRequestBase, E as chunkToString, G as getCustom500Route, H as createAsyncManifestMemo, I as isRenderInstruction, J as isRoute404, K as getDefaultStatusCode, L as normalizeCspResourceEntry, O as renderSlotToString, Q as normalizeThePath, R as pushDirective, S as renderPage, St as removeTrailingForwardSlash, U as createManifestMemo, W as getCustom404Route, X as getErrorRoutePath, Y as isRoute500, Z as normalizeTheLocale, _ as DEFAULT_404_ROUTE, a as getRouteGenerator, at as fetchStateSymbol, b as readBodyWithLimit, bt as removeLeadingForwardSlash, ct as shouldAppendForwardSlash, d as getEnvironment, dt as generateCspDigest, et as ASTRO_ERROR_HEADER, f as copyRequest, ft as appendForwardSlash, g as validateAndDecodePathname, gt as isInternalPath, h as MultiLevelEncodingError, ht as hasFileExtension, i as getRouteCache, it as clientAddressSymbol, k as isRenderTemplateResult, l as AstroIntegrationLogger, lt as defineMiddleware, m as setOriginPathname, mt as collapseDuplicateTrailingSlashes, n as getParams, nt as REDIRECT_STATUS_CODES, o as getLogger, ot as originPathnameSymbol, p as getOriginPathname, pt as collapseDuplicateSlashes, q as routeHasHtmlExtension, r as getProps, rt as REROUTABLE_STATUS_CODES, s as getResolvedLogger, st as responseSentSymbol$1, t as sequence, tt as ASTRO_GENERATOR, u as astroToRuntimeLogger, ut as decodeKey, v as SERVER_ISLAND_COMPONENT, vt as joinPaths, y as BodySizeLimitError, yt as prependForwardSlash } from "./chunks/sequence_Qu4yb8w1.mjs";
...
var middlewareSecret = "3edeccf3-2ec6-43ca-8cc5-f80b3bf1b8b1";
//#endregion
...
[
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/auth/recuperar",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/auth\\/recuperar\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/api/auth/recuperar.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/perfil.ts",
			"pathname": "/api/perfil",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/recuperar.astro",
			"pathname": "/recuperar",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
...
var _page0 = () => import("./chunks/generic_CukZ7bAm.mjs").then((n) => n.t);
var _page1 = () => import("./chunks/callback_B32jdbrR.mjs");
var _page2 = () => import("./chunks/login_DVzhxOeL.mjs");
var _page3 = () => import("./chunks/logout_W7gtYf3c.mjs");
var _page4 = () => import("./chunks/recuperar_C0jvdc8E.mjs");
var _page5 = () => import("./chunks/register__YFB8mqi.mjs");
var _page6 = () => import("./chunks/perfil_C52jDuG5.mjs");
var _page7 = () => import("./chunks/login_BbP9jOoJ.mjs");
var _page8 = () => import("./chunks/perfil_gzfvBC4Z.mjs");
var _page9 = () => import("./chunks/recuperar_-O7DePdF.mjs");
var _page10 = () => import("./chunks/register_BZA6WvO4.mjs");
var pageMap = /* @__PURE__ */ new Map([
	...
	["src/pages/api/auth/recuperar.ts", _page4],
	["src/pages/api/auth/register.ts", _page5],
	["src/pages/api/perfil.ts", _page6],
	["src/pages/login.astro", _page7],
	["src/pages/perfil.astro", _page8],
	["src/pages/recuperar.astro", _page9],
	["src/pages/register.astro", _page10]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///home/fran/MEGA/Proyectos_Prog/Clases%202026/ING%20SOFTWARE%20II/ADOPTY/adopty/","cacheDir":"file:///home/fran/MEGA/Proyectos_Prog/Clases%202026/ING%20SOFTWARE%20II/ADOPTY/adopty/node_modules/.astro/","outDir":"file:///home/fran/MEGA/Proyectos_Prog/Clases%202026/ING%20SOFTWARE%20II/ADOPTY/adopty/dist/","srcDir":"file:///home/fran/MEGA/Proyectos_Prog/Clases%202026/ING%20SOFTWARE%20II/ADOPTY/adopty/src/","publicDir":"file:///home/fran/MEGA/Proyectos_Prog/Clases%202026/ING%20SOFTWARE%20II/ADOPTY/adopty/public/","buildClientDir":"file:///home/fran/MEGA/Proyectos_Prog/Clases%202026/ING%20SOFTWARE%20II/ADOPTY/adopty/dist/client/","buildServerDir":"file:///home/fran/MEGA/Proyectos_Prog/Clases%202026/ING%20SOFTWARE%20II/ADOPTY/adopty/.vercel/output/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/callback","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/callback\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"callback","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/callback.ts","pathname":"/api/auth/callback","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/login","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/login\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/login.ts","pathname":"/api/auth/login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/logout","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/logout\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"logout","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/logout.ts","pathname":"/api/auth/logout","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/recuperar","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/recuperar\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"recuperar","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/recuperar.ts","pathname":"/api/auth/recuperar","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/register","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/register\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"register","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/register.ts","pathname":"/api/auth/register","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/perfil","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/perfil\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"perfil","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/perfil.ts","pathname":"/api/perfil","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/explorar","isIndex":false,"type":"page","pattern":"^\\/explorar\\/?$","segments":[[{"content":"explorar","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/explorar.astro","pathname":"/explorar","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/mockPets.Cf8-XZmF.css"}],"routeData":{"route":"/login","isIndex":false,"type":"page","pattern":"^\\/login\\/?$","segments":[[{"content":"login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/login.astro","pathname":"/login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/mockPets.Cf8-XZmF.css"}],"routeData":{"route":"/perfil","isIndex":false,"type":"page","pattern":"^\\/perfil\\/?$","segments":[[{"content":"perfil","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/perfil.astro","pathname":"/perfil","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/mockPets.Cf8-XZmF.css"}],"routeData":{"route":"/recuperar","isIndex":false,"type":"page","pattern":"^\\/recuperar\\/?$","segments":[[{"content":"recuperar","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/recuperar.astro","pathname":"/recuperar","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/mockPets.Cf8-XZmF.css"}],"routeData":{"route":"/register","isIndex":false,"type":"page","pattern":"^\\/register\\/?$","segments":[[{"content":"register","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/register.astro","pathname":"/register","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/home/fran/MEGA/Proyectos_Prog/Clases 2026/ING SOFTWARE II/ADOPTY/adopty/src/pages/explorar.astro",{"propagation":"none","containsHead":true}],["/home/fran/MEGA/Proyectos_Prog/Clases 2026/ING SOFTWARE II/ADOPTY/adopty/src/pages/index.astro",{"propagation":"none","containsHead":true}],["/home/fran/MEGA/Proyectos_Prog/Clases 2026/ING SOFTWARE II/ADOPTY/adopty/src/pages/login.astro",{"propagation":"none","containsHead":true}],["/home/fran/MEGA/Proyectos_Prog/Clases 2026/ING SOFTWARE II/ADOPTY/adopty/src/pages/perfil.astro",{"propagation":"none","containsHead":true}],["/home/fran/MEGA/Proyectos_Prog/Clases 2026/ING SOFTWARE II/ADOPTY/adopty/src/pages/recuperar.astro",{"propagation":"none","containsHead":true}],["/home/fran/MEGA/Proyectos_Prog/Clases 2026/ING SOFTWARE II/ADOPTY/adopty/src/pages/register.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000virtual:astro:middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/api/auth/callback@_@ts":"chunks/callback_B32jdbrR.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_CukZ7bAm.mjs","\u0000virtual:astro:page:src/pages/login@_@astro":"chunks/login_BbP9jOoJ.mjs","\u0000virtual:astro:page:src/pages/api/auth/login@_@ts":"chunks/login_DVzhxOeL.mjs","\u0000virtual:astro:page:src/pages/api/auth/logout@_@ts":"chunks/logout_W7gtYf3c.mjs","\u0000virtual:astro:page:src/pages/api/perfil@_@ts":"chunks/perfil_C52jDuG5.mjs","\u0000virtual:astro:page:src/pages/perfil@_@astro":"chunks/perfil_gzfvBC4Z.mjs","\u0000virtual:astro:page:src/pages/recuperar@_@astro":"chunks/recuperar_-O7DePdF.mjs","\u0000virtual:astro:page:src/pages/api/auth/recuperar@_@ts":"chunks/recuperar_C0jvdc8E.mjs","\u0000virtual:astro:page:src/pages/register@_@astro":"chunks/register_BZA6WvO4.mjs","\u0000virtual:astro:page:src/pages/api/auth/register@_@ts":"chunks/register__YFB8mqi.mjs","/home/fran/MEGA/Proyectos_Prog/Clases 2026/ING SOFTWARE II/ADOPTY/adopty/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_L2-6rc5A.mjs","/home/fran/MEGA/Proyectos_Prog/Clases 2026/ING SOFTWARE II/ADOPTY/adopty/src/pages/perfil.astro?astro&type=script&index=0&lang.ts":"_astro/perfil.astro_astro_type_script_index_0_lang.htzPVlDo.js","/home/fran/MEGA/Proyectos_Prog/Clases 2026/ING SOFTWARE II/ADOPTY/adopty/src/pages/recuperar.astro?astro&type=script&index=0&lang.ts":"_astro/recuperar.astro_astro_type_script_index_0_lang.CkfM82wp.js","/home/fran/MEGA/Proyectos_Prog/Clases 2026/ING SOFTWARE II/ADOPTY/adopty/src/pages/register.astro?astro&type=script&index=0&lang.ts":"_astro/register.astro_astro_type_script_index_0_lang.CRQqBrLa.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/home/fran/MEGA/Proyectos_Prog/Clases 2026/ING SOFTWARE II/ADOPTY/adopty/src/pages/perfil.astro?astro&type=script&index=0&lang.ts","document.getElementById(`perfForm`).addEventListener(`submit`,async e=>{e.preventDefault();let t=document.getElementById(`err`),n=document.getElementById(`ok`);t.classList.add(`hidden`),n.classList.add(`hidden`);let r=new FormData(e.target),i=e.target.hasAttribute(`data-org`)?{nombre_oficial:r.get(`nombre_oficial`),direccion:r.get(`direccion`),sitio_web:r.get(`sitio_web`),descripcion:r.get(`descripcion`)}:{nombre:r.get(`nombre`),telefono:r.get(`telefono`),descripcion:r.get(`descripcion`)},a=await fetch(`/api/perfil`,{method:`PUT`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify(i)}),o=await a.json().catch(()=>({}));if(!a.ok){t.textContent=o.error??`Error al guardar`,t.classList.remove(`hidden`);return}n.textContent=`Perfil actualizado.`,n.classList.remove(`hidden`)});"],["/home/fran/MEGA/Proyectos_Prog/Clases 2026/ING SOFTWARE II/ADOPTY/adopty/src/pages/recuperar.astro?astro&type=script&index=0&lang.ts","document.getElementById(`recForm`).addEventListener(`submit`,async e=>{e.preventDefault();let t=document.getElementById(`err`),n=document.getElementById(`ok`);t.classList.add(`hidden`),n.classList.add(`hidden`);let r=new FormData(e.target),i=await fetch(`/api/auth/recuperar`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify({correo:r.get(`correo`)})}),a=await i.json().catch(()=>({}));if(!i.ok){t.textContent=a.error??`Error`,t.classList.remove(`hidden`);return}n.textContent=`Si el correo existe, recibirás el enlace en unos minutos.`,n.classList.remove(`hidden`)});"],["/home/fran/MEGA/Proyectos_Prog/Clases 2026/ING SOFTWARE II/ADOPTY/adopty/src/pages/register.astro?astro&type=script&index=0&lang.ts","document.getElementById(`regForm`).addEventListener(`submit`,async e=>{e.preventDefault();let t=document.getElementById(`err`),n=document.getElementById(`ok`);t.classList.add(`hidden`),n.classList.add(`hidden`);let r=new FormData(e.target),i=await fetch(`/api/auth/register`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify({nombre:r.get(`nombre`),correo:r.get(`correo`),password:r.get(`password`),tipo_usuario:r.get(`tipo_usuario`)})});if(i.redirected){location.href=i.url;return}let a=await i.json().catch(()=>({}));if(!i.ok){t.textContent=a.error??`Error al registrar`,t.classList.remove(`hidden`);return}a.confirmaEmail&&(n.textContent=`Revisa tu correo para confirmar la cuenta y luego entra.`,n.classList.remove(`hidden`))});"]],"assets":["/favicon.ico","/favicon.svg","/assets/1.jpeg","/assets/2.jpeg","/assets/3.jpeg","/assets/4.jpg","/assets/5.jpeg","/assets/6.JPG","/assets/7.jpeg","/assets/8.jpeg","/assets/9.jpg","/assets/logo.svg","/brand/adopty-logo-full.png","/brand/adopty-logo-icon.png","/brand/adopty-logo-text.png","/_astro/mockPets.Cf8-XZmF.css","/explorar/index.html","/index.html"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"W/M0BhatqPyNWF8yG5Xgcc5LkUexZ+ljmdUXY7F+FHo=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"MODE": "production",
			"PROD": true,
			"PUBLIC_SUPABASE_ANON_KEY": "PENDIENTE_poner_anon_key_del_dashboard",
			"PUBLIC_SUPABASE_URL": "https://dvebieysgnhmimmxjwjc.supabase.co",
			"SITE": void 0,
			"SSR": true
...
var entrypoint_default = { async fetch(request) {
	...
	} else if (url.searchParams.get("x_astro_path_token") === "3edeccf3-2ec6-43ca-8cc5-f80b3bf1b8b1") {
		overrideTrusted = true;
